...
insert certificate_tag(tag_id, certificate_id)
VALUES (3, 1);
insert certificate_tag(tag_id, certificate_id)
VALUES (2, 2);
insert certificate_tag(tag_id, certificate_id)
...
values ('Petr', 'Petrov');
insert user(first_name, last_name)
values ('Sidor', 'Sidorov');

insert account(login, password)
VALUES ('root', '$2y$12$nDIbpnb/9S61LuSKF2JFt.AUHSESFw.xPwr/Ie6U6DvACFJuZACuq');
insert account(login, password)
VALUES ('Ivanov', '$2y$12$nDIbpnb/9S61LuSKF2JFt.AUHSESFw.xPwr/Ie6U6DvACFJuZACuq');
insert account(login, password)
VALUES ('Petrov', '$2y$12$nDIbpnb/9S61LuSKF2JFt.AUHSESFw.xPwr/Ie6U6DvACFJuZACuq');
insert account(login, password)
VALUES ('Sidorov', '$2y$12$nDIbpnb/9S61LuSKF2JFt.AUHSESFw.xPwr/Ie6U6DvACFJuZACuq');

insert role(id, name, description)
VALUES (2, 'USER', 'Regular user');
insert role(id, name, description)
...
insert orders(user_id, certificate_id, purchase_date, amount, quantity)
VALUES (2, 2, '2021-03-22 09:20:11', 150, 1);
insert orders(user_id, certificate_id, purchase_date, amount, quantity)
VALUES (3, 3, '2021-04-22 19:21:21', 122, 1);
insert orders(user_id, certificate_id, purchase_date, amount, quantity)
VALUES (4, 1, '2021-03-22 09:20:11', 33, 3);
insert orders(user_id, certificate_id, purchase_date, amount, quantity)
VALUES (3, 3, '2021-04-22 19:21:21', 12, 2);
insert orders(user_id, certificate_id, purchase_date, amount, quantity)
VALUES (2, 3, '2021-03-22 09:20:11', 150, 1);
insert orders(user_id, certificate_id, purchase_date, amount, quantity)
VALUES (1, 2, '2021-03-22 09:20:11', 10, 2);
insert orders(user_id, certificate_id, purchase_date, amount, quantity)
VALUES (4, 5, '2021-04-22 19:21:21', 11, 1);
