...
public class ErrorCodes {
    ...
    public static final int CERTIFICATE_INTERNAL_ERROR = 50001;
    ...
    public static final int TAG_INTERNAL_ERROR = 50002;
    ...
    public static final int USER_INTERNAL_ERROR = 50003;
